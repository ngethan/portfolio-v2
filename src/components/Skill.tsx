        ...
        <motion.div variants={itemY}>
            ...
            >
                <p
                    className={
                        noName
                            ? "-tranprimary-x-1/2 invisible opacity-0 px-[10px] fixed group-hover:visible group-hover:opacity-100 text-gray-200 w-fit h-[20] bg-gray-700 rounded duration-300 left-[50%] bottom-[60px] z-[100]"
                            : "invisible fixed"
                    }
                >
                    {name}
