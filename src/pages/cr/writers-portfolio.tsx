    ...
    return (
        ...
        >
            ...
            <motion.div className="text-[17px] pb-[50px]" variants={itemY}>
                <p>
                    The original works and reflections contained in the list of
                    sub-pages below are all pieces I wrote as part of the
            ...
            <motion.div className="w-full flex justify-center" variants={itemY}>
                <ul className="max-w-[1000px] hidden md:flex flex-row flex-wrap justify-center">
                    <Link
                        href="/writers-portfolio/creative-non-fiction"
                    ...
                    <Link
                        href="/writers-portfolio/food-writing"
                    ...
                    <Link
                        href="/writers-portfolio/research-paper"
                    ...
                    <Link
                        href="/writers-portfolio/art-fiction"
