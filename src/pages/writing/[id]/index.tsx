...
const ViewBlogPage = ({
  ...
  const styles = {
    ...
    quote:
      "text-gray-100 font-code italic font-serif bg-gray-800 rounded-lg px-2 py-1",
                            ...
                            d.type === "break"
                              ...
                              : React.createElement(
                                  d.type,
                                  {
                                    ...
                                    }${(styles as any)[d.type] || styles.p}${
                                      d.underline ? ` ${styles.underline}` : ""
                                    }`,
                                    key: k,
                                  },
                                  d.text
                    ...
                    React.createElement(
                      c.type,
                      {
                        className: `${c.className ? `${c.className} ` : ""}${
                          (styles as any)[c.type] || styles.p
                        }${c.underline ? ` ${styles.underline}` : ""}`,
                        key: i,
                      },
                      c.text
                    )
